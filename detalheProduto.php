  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h1 class="mb-3 bread">Detalhe do Produto</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="row no-gutters">
          ...
          <form method="POST" id="contactForm" name="contactForm" class="contactForm">
            <div class="row">
              <div class="col-md-6">
                ...
                <label class="label" for="name"><?php echo $produto->codigo;?></label><br>
                <label class="label" for="name"><?php echo $produto->produto;?></label><br>
                <label class="label" for="name">R$ <?php echo number_format($produto->preco, 2, ',', '.');?></label><br>
                <label class="label" for="name"><?php echo $produto->descricao;?></label><br>
                <a class="btn btn-primary" href="pedido.php?acao=addP&produtoId=<?=$produto->produtoId;?>">COMPRAR</a>
                </div>
              </div>
            </div>
          </form>
      ...
      <div class="col-md-5 d-flex align-items-stretch">
        <div class="info-wrap w-100 p-5 img" style="background-image: url(<?php echo "admin/Imagens/produtos/". $produto->imagem;?>);">
        </div>
      </div>
    </div>
  </div>
