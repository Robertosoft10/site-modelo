  ...
  <body>
    <div class="container pt-5 pb-4">
            ...
            <?php if(isset($_SESSION['loginVazio'])){ ?>
              <small id="loginErro"><?php echo $_SESSION['loginVazio'];?></small>
              <?php unset($_SESSION['loginVazio']); } ?>

              <?php if(isset($_SESSION['loginIncorreto'])){ ?>
                <small id="loginErro"><?php echo $_SESSION['loginIncorreto'];?></small>
                <?php unset($_SESSION['loginIncorreto']); } ?>

                <?php if(isset($_SESSION['userOk'])){ ?>
                  <small id="loginAcerto"><?php echo $_SESSION['userOk'];?></small>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h1 class="mb-3 bread">Login e Cadastro</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="row no-gutters">
      <div class="col-md-7">
        <div class="contact-wrap w-100 p-md-5 p-4">
          ...
          <form action="salvarUsuario.php" method="POST" id="contactForm" name="contactForm" class="contactForm">
            <div class="row">
              <div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label class="label" for="subject">Senha *</label>
      ...
      <div class="col-md-5 d-flex align-items-stretch">
        <div class="info-wrap w-100 p-5 img">
          ...
          <form action="logar.php" method="POST" id="contactForm" name="contactForm" class="contactForm">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <input type="submit" value="Fazer login" class="btn btn-primary col-md-12">
                  <div class="submitting"></div>
                </div>
              </div>
            </div>
